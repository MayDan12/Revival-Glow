...
export default function OrderConfirmationEmail({
  ...
  orderNumber = "#1000",
  orderTotal = "$0.00",
  orderTrackingUrl = "https://yourwebsite.com/tracking",
        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              Thank you for your order! We have received your order {orderNumber} and are preparing it for shipment.
            </Text>
            <Section style={orderDetails}>
              <Text style={detailText}>Order Number: {orderNumber}</Text>
              <Text style={detailText}>Total: {orderTotal}</Text>
            </Section>
            {orderTrackingUrl && (
            ...
            <Text style={paragraph}>
              If you have any questions, reply to this email or contact us at support@revivalglow.com.
            </Text>
