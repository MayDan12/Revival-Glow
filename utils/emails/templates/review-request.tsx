...
export default function ReviewRequestEmail({
  ...
  itemName = "your recent purchase",
  reviewUrl = "https://yourwebsite.com/review",
        ...
        <Container style={container}>
          ...
          <Section style={content}>
            ...
            <Text style={paragraph}>
              We hope you are enjoying {itemName}! We&apos;d love to hear your thoughts.
            </Text>
            <Text style={paragraph}>
              Your feedback helps us improve and helps other customers make great choices. 
            ...
            <Text style={paragraph}>Thank you for your support!</Text>
